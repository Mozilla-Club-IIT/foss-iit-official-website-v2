...
export default function Nav() {
    return (
        <nav className="fixed inset-x-6 top-8 z-20 h-20 flex">
            <div className="h-20 w-full flex items-center rounded-2xl bg-black/[48%] pl-8 pr-12 ring-1 ring-border-nav/[42%] backdrop-blur-sm">
